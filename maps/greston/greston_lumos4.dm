var/datum/planet/lumos4/planet_lumos4 = null
...
/datum/planet/lumos4
	name = "Greston-4"
	desc = "NanoTrasen recently opened this research station on the search for the unknown to all.
		While many question its true intents, NanoTrasen ensures that it will keep the safety of its
		employees in mind."
	current_time = new /datum/time/lumos4()
	expected_z_levels = list(
						Z_LEVEL_SURFACE_UNDER
						Z_LEVEL_SURFACE_LOW,
						Z_LEVEL_SURFACE_MID,
						Z_LEVEL_SURFACE_HIGH)
	planetary_wall_type = /turf/unsimulated/wall/planetary/lumos4

/datum/planet/lumos4/New()
	..()
	planet_lumos4 = src
	weather_holder = new /datum/weather_holder/lumos4(src)

/datum/planet/lumos4/update_sun()
	..()
...
/datum/weather_holder/lumos4
	temperature = T0C
	allowed_weather_types = list(
		WEATHER_CLEAR		= new /datum/weather/lumos4/clear(),
		WEATHER_OVERCAST	= new /datum/weather/lumos4/overcast(),
		WEATHER_LIGHT_SNOW	= new /datum/weather/lumos4/light_snow(),
		WEATHER_SNOW		= new /datum/weather/lumos4/snow(),
		WEATHER_BLIZZARD	= new /datum/weather/lumos4/blizzard(),
		WEATHER_RAIN		= new /datum/weather/lumos4/rain(),
		WEATHER_STORM		= new /datum/weather/lumos4/storm(),
		WEATHER_HAIL		= new /datum/weather/lumos4/hail(),
		WEATHER_BLOOD_MOON	= new /datum/weather/lumos4/blood_moon()
		)
...
/datum/weather/lumos4
	name = "lumos4 base"
	temp_high = 303.15 // 30c
	temp_low = 283.15  // 10c

/datum/weather/lumos4/clear
	name = "clear"
...
/datum/weather/lumos4/light_snow
	name = "light snow"
...
/datum/weather/lumos4/light_snow/process_effects()
	..()
...
/datum/weather/lumos4/snow/process_effects()
	..()
	for(var/mob/living/L in living_mob_list)
		if(L.z in holder.our_planet.expected_z_levels)
			var/turf/T = get_turf(L)
...
/datum/weather/lumos4/blizzard/process_effects()
	..()
	for(var/mob/living/L in living_mob_list)
		if(L.z in holder.our_planet.expected_z_levels)
			var/turf/T = get_turf(L)
...
/datum/weather/lumos4/rain/process_effects()
	..()
	for(var/mob/living/L in living_mob_list)
		if(L.z in holder.our_planet.expected_z_levels)
			var/turf/T = get_turf(L)
...
/datum/weather/lumos4/storm/process_effects()
	..()
	for(var/mob/living/L in living_mob_list)
		if(L.z in holder.our_planet.expected_z_levels)
			var/turf/T = get_turf(L)
...
/datum/weather/lumos4/storm/proc/handle_lightning()
...
/datum/weather/lumos4/hail/process_effects()
	..()
...
/datum/weather/lumos4/blood_moon
	name = "blood moon"
	light_modifier = 0.5
	light_color = "#FF0000"
