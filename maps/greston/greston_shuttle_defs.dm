...
/datum/shuttle/autodock/multi/mercenary
	...
	destinations = list(
		...
		"greston_space_SE",
		"greston_space_SW",
		"greston_dockarm_d2l"	// End of right docking arm
		)
	docking_controller_tag = "merc_shuttle"
	announcer = "Automated Traffic Control"
	arrival_message = "Attention. An unregistered vessel is approaching Lumos-4."
	departure_message = "Attention. A unregistered vessel is now leaving Lumos-4."
...
/datum/shuttle/autodock/multi/ninja
	...
	destinations = list(
		...
		"greston_space_SE",
		"greston_space_SW",
		"greston_dockarm_d1a3"	// Inside of left dockarm
		)
...
/datum/shuttle/autodock/multi/heist
	...
	destinations = list(
		...
		"greston_space_SE",
		"greston_space_SW",
		"greston_dockarm_d1l"	// End of left dockarm
		)
	//docking_controller_tag = ??? doesn't have one?
	destination_dock_targets = list(
		"Mercenary base" = "merc_base",
		"greston spaceport" = "nuke_shuttle_dock_airlock",
		)
	announcer = "Automated Traffic Control"
...
/datum/shuttle/autodock/multi/specialops
	...
	destination_tags = list(
		...
		"greston_space_SE",
		"greston_space_SW",
		"greston_dockarm_d2a2"	// Top of right docking arm
		)
