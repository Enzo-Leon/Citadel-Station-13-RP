// This causes greston submap maps to get 'checked' and compiled, when undergoing a unit test.
// This is so Travis can validate PoIs, and ensure future changes don't break PoIs, as PoIs are loaded at runtime and the compiler can't catch errors.

//////////////////////////////////////////////////////////////////////////////
/// Static Load
/datum/map_template/greston_lateload/greston_misc
	name = "greston - Misc"
	desc = "Misc areas, like some transit areas, holodecks, merc area."
	mappath = 'greston_misc.dmm'

	associated_map_datum = /datum/map_z_level/greston_lateload/ships

	ztraits = list()

/datum/map_z_level/greston_lateload/misc
	name = "Misc"
	flags = MAP_LEVEL_ADMIN|MAP_LEVEL_SEALED

/datum/map_template/greston_lateload/greston_ships
	name = "greston - Ships"
	desc = "Ship transit map and whatnot."
	mappath = 'greston_ships.dmm'

	associated_map_datum = /datum/map_z_level/greston_lateload/ships

	ztraits = list()

/datum/map_z_level/greston_lateload/ships
	name = "Ships"
	flags = MAP_LEVEL_ADMIN|MAP_LEVEL_SEALED
/*
#include "underdark_pois/_templates.dm"
#include "underdark_pois/underdark_things.dm"
/datum/map_template/greston_lateload/greston_underdark
	name = "Greston - Underdark"
	desc = "Mining, but harder."
	mappath = 'greston_underdark.dmm'

	ztraits = list(ZTRAIT_MINING = TRUE, ZTRAIT_GRAVITY = TRUE)

	associated_map_datum = /datum/map_z_level/greston_lateload/underdark

/datum/map_z_level/greston_lateload/underdark
	name = "Underdark"
	flags = MAP_LEVEL_CONTACT|MAP_LEVEL_PLAYER
	base_turf = /turf/simulated/mineral/floor/virgo3b
	z = Z_LEVEL_UNDERDARK

/datum/map_template/greston_lateload/greston_underdark/on_map_loaded(z)
	. = ..()
...
/datum/map_template/greston_lateload/away_beach
	name = "Desert Planet - Z1 Beach"
	desc = "The beach away mission."
	mappath = 'beach/beach.dmm'
	associated_map_datum = /datum/map_z_level/greston_lateload/away_beach

	ztraits = list(ZTRAIT_AWAY = TRUE, ZTRAIT_GRAVITY = TRUE)

/datum/map_z_level/greston_lateload/away_beach
	name = "Away Mission - Desert Beach"
	z = Z_LEVEL_BEACH

/datum/map_template/greston_lateload/away_beach_cave
	name = "Desert Planet - Z2 Cave"
	desc = "The beach away mission's cave."
	mappath = 'beach/cave.dmm'
	associated_map_datum = /datum/map_z_level/greston_lateload/away_beach_cave

	ztraits = list(ZTRAIT_AWAY = TRUE, ZTRAIT_GRAVITY = TRUE)

/datum/map_template/greston_lateload/away_beach_cave/on_map_loaded(z)
	. = ..()
	seed_submaps(list(Z_LEVEL_BEACH_CAVE), 120, /area/greston_away/cave/unexplored/normal, /datum/map_template/surface/mountains/normal)
	//seed_submaps(list(Z_LEVEL_BEACH_CAVE), 70, /area/greston_away/cave/unexplored/normal, /datum/map_template/surface/mountains/deep)
...
/datum/map_z_level/greston_lateload/away_beach_cave
...
/*
/datum/map_template/greston_lateload/gateway
	name = "Gateway Submap"
	desc = "Please do not use this."
	mappath = null
	associated_map_datum = null

/datum/map_z_level/greston_lateload/gateway_destination
	name = "Gateway Destination"
	z = Z_LEVEL_GATEWAY

#include "gateway/snow_outpost.dm"
/datum/map_template/greston_lateload/gateway/snow_outpost
	name = "Snow Outpost"
	desc = "Big snowy area with various outposts."
	mappath = 'gateway/snow_outpost.dmm'
	associated_map_datum = /datum/map_z_level/greston_lateload/gateway_destination

#include "gateway/zoo.dm"
/datum/map_template/greston_lateload/gateway/zoo
	name = "Zoo"
...
/datum/map_template/greston_lateload/gateway/carpfarm
	name = "Carp Farm"
...
/datum/map_template/greston_lateload/gateway/snowfield
	name = "Snow Field"
...
/datum/map_template/greston_lateload/gateway/listeningpost
	name = "Listening Post"
...
//////////////////////////////////////////////////////////////////////////////////////
// Code Shenanigans for greston lateload maps
/datum/map_template/greston_lateload
	allow_duplicates = FALSE
	var/associated_map_datum

/datum/map_template/greston_lateload/on_map_loaded(z)
...
/datum/map_z_level/greston_lateload
	z = 0
	flags = MAP_LEVEL_SEALED

/datum/map_z_level/greston_lateload/New(var/datum/map/map, mapZ)
	if(mapZ && !z)
		z = mapZ
	return ..(map)
...
/obj/greston_away_spawner/Initialize()
	. = ..()
...
/obj/greston_away_spawner/process()
...
/obj/greston_away_spawner/shadekin
