...
/obj/machinery/telecomms/relay/preset/greston/midpoint
	id = "Midpoint Relay"
	listening_level = Z_LEVEL_TRANSIT
	autolinkers = list("tmp_relay")

/obj/machinery/telecomms/relay/preset/centcom/greston/midpoint
	listening_level = Z_LEVEL_TRANSIT
...
/obj/machinery/telecomms/relay/preset/greston/station_low
	id = "Station Relay 1"
	listening_level = Z_LEVEL_SPACE_LOW
	autolinkers = list("tsl_relay")

/obj/machinery/telecomms/relay/preset/centcom/greston/station_low
	listening_level = Z_LEVEL_SPACE_LOW

/obj/machinery/telecomms/relay/preset/greston/station_mid
	id = "Station Relay 2"
	listening_level = Z_LEVEL_SPACE_MID
	autolinkers = list("tsm_relay")

/obj/machinery/telecomms/relay/preset/centcom/greston/station_mid
	listening_level = Z_LEVEL_SPACE_MID

/obj/machinery/telecomms/relay/preset/greston/station_high
	id = "Station Relay 3"
	listening_level = Z_LEVEL_SPACE_HIGH
	autolinkers = list("tsh_relay")

/obj/machinery/telecomms/relay/preset/centcom/greston/station_high
	listening_level = Z_LEVEL_SPACE_HIGH

/obj/machinery/telecomms/relay/preset/greston/sci_outpost
	id = "Science Outpost Relay"
	listening_level = Z_LEVEL_SOLARS
	autolinkers = list("sci_o_relay")

/obj/machinery/telecomms/relay/preset/centcom/greston/sci_outpost
	listening_level = Z_LEVEL_SOLARS
